package com.hyphenate.chat.demo.callkit
...
import com.hyphenate.chat.demo.utils.ToastUtils
...
object EaseCallKitManager {
    ...
    private const val FETCH_TOKEN_URL = BuildConfig.APP_SERVER_PROTOCOL + "://" + BuildConfig.APP_SERVER_DOMAIN +
            BuildConfig.APP_RTC_TOKEN_URL
    private const val FETCH_USER_MAPPER = BuildConfig.APP_SERVER_PROTOCOL + "://" + BuildConfig.APP_SERVER_DOMAIN +
            BuildConfig.APP_RTC_CHANNEL_MAPPER_URL

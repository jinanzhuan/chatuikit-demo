...
import com.hyphenate.chat.demo.common.extensions.internal.addDefaultTextChangedListener
import com.hyphenate.chat.demo.databinding.DemoFragmentServerSetBinding
...
class ServerSetFragment: EaseBaseFragment<DemoFragmentServerSetBinding>() {
    ...
    override fun initData() {
        super.initData()
        DemoHelper.getInstance().getDataModel().isCustomSetEnable().let {
            if (it) {
